...
| apoc_batch_size | `--apoc-batch-size` | `HINTGRID_APOC_BATCH_SIZE` | `10000` | `10000` | Размер батча для `apoc.periodic.iterate`: SIMILAR_TO, INTERESTED_IN, узлы UserCommunity/PostCommunity и BELONGS_TO (1–100000) |
